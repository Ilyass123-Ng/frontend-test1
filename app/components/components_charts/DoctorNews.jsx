...
export function DoctorNews() {
  return (
    <Card className="border-0 shadow-sm p-4 text-white d-flex flex-column h-100 w-100 card-prem fade-in" style={{ borderRadius: '24px', background: 'linear-gradient(135deg, #9ab0e7ff 0%, #3b71ca 100%)', minHeight: '340px' }}>
      <div className="d-flex justify-content-between align-items-center mb-4">
         ...
         <span className="badge rounded-pill bg-dark bg-white px-3 py-2 text-dark" style={{ fontSize: '10px' }}>Today's info</span>
      </div>
